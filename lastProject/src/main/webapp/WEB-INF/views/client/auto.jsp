...
<div id="container">
	...
	<div class="sectionArea">
		...
		<div class="content">
			...
			<div>
				<p>
					<b> 「고객의 소리」는 평생능력개발, 자격시험, 외국인고용지원 및 해외취업, 숙련기술장려와 기능경기 등 공단에서
						수행하는 사 <br> 업에 대한 문의와 제안 등을 접수, 확인하는 홈페이지입니다. <br> <br>
						알파넷, NCS 등 공단사업 개별 홈페이지에서 로그인 이후 해당 홈페이지에서 「고객의 소리」홈페이지로 접속하신 경우,
						다시 <br> 한번 본인 확인 절차(실명제 운영)를 진행하고 있으며 이는 개인정보의 오남용을 막기 위한
						절차이오니 양해 부탁드립니다. <br> (사용자 인증정보는 60분 동안 유지됩니다.) <br> <br>
						만 14세 미만 아동의 경우 개인정보보호법에 의해 민원접수 및 답변확인과 관련하여 개인정보 수집·이용 등을 위해
						법정대리인 <br> 의 동의가 필요합니다. (최초 1회 민원 접수 시) <br> ※ 만 14세 미만
						아동의 본인 인증 후 법정대리인의 동의 및 본인 인증 절차가 이어집니다. <br> <br>
						이메일인증, 휴대전화 인증, 법정대리인의 동의가 불가한 경우 HRD고객센터(1644-8000)를 이용해 주시기
						바랍니다. <br>
					</b>
				</p>
				<div class="">
