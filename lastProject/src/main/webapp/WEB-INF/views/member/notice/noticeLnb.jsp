				...
				<ul id="lnbNavi" class="lnb on">
					<li class="low active on"><a>공지사항</a>
						<ul style="display: block;">
							...
							<li><a href="<%=request.getContextPath() %>/qualificationsSystem">자격제도</a></li>
							<li><a href="<%=request.getContextPath() %>/qualificationsSystem">시행</a></li>
							<li><a href="<%=request.getContextPath() %>/qualificationsSystem">출제</a></li>
							<li><a href="<%=request.getContextPath() %>/qualificationsSystem">서비스 개선</a></li>
						</ul></li>
