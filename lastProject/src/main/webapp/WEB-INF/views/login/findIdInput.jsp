	...
	$(function(){
    	$('#bbton').click(function(){
			...
			if(nm==null || nm==""){
				...
				if(idd==null || idd==""){
					window.open("goFindId?nm="+nm+"&bir="+bir1+"&ph="+ph1 ,"findId","width=300px,height=200px, left=700px,top=200px");
				}else{
	...
	<div class="form_box">
		<fieldset>
			...
			<p>
				...
				<input type="text" name="mPhone02" id="mPhone02" class="form_text numInput" style="width:40px;height:21px;" title="전화번호 앞자리 입력" maxlength="4"> <em>-</em> <input type="password" name="mPhone03" id="mPhone03" class="form_text numInput" style="width:40px;height:21px;" title="전화번호 뒷자리 입력" maxlength="4">
			<button type="button" class="btn_login" onclick="window.close()" style="float:right;margin-left:10px;"><span>닫기</span></button>
			<button type="button" class="btn_login" id="bbton" onclick="getID()" style="float:right;"><span>조회</span></button>
			</p>
		</fieldset>
	</div>
</div>