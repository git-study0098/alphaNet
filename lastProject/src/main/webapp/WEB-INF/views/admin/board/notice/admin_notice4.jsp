...
<article>
	...
	<div id="page-wrapper">
		<div id="page-inner">
			...
			<hr />
			<div class="dropdown">
				<button class="dropbtn">출제 게시판</button>
			...
			<div class="content">
				<div>
					...
					<form name="noticeDetail">
						<input type="hidden" name="notice_code" value="notice04">
						<div id="viewList">
							<div class="tbl_type1">
											...
											<c:when test="${viewData.notice1CountPerPage > 0 }">
												<c:forEach items="${viewData.notice1List }" var="notice"
													...
													<tr>
														...
														<!-- 글번호 -->
														<td><a
															href="<%=request.getContextPath() %>/admin/boardUpdateForm4?notice_code=${notice.notice_code }">${notice.title}</a></td>
							...
							<a href="<%=request.getContextPath()%>/admin/adminRegist4"><input
 ...
 %>
									<button type="button" class="btn5"
										onclick="location.href='notice4?page=<%=i%>'" title="<%=i%>페이지">
										<span><%=i%></span>
									</button> <%
 	}
 	}
