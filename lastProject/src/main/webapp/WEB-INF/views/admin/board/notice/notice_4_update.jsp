...
<script>
	function boardDelete4(){
		location.href="<%=request.getContextPath() %>/admin/boardDelete4?notice_code=${vo.notice_code}";
	}
</script>
...
<article>
	<div id="page-wrapper">
		<div id="page-inner">
			...
			<hr />
			<form style="display: inline" action="boardUpdate4" method="post"
				...
				<div>
					...
					<p class="txt_right">
						<input type="submit" class="btn btncolor1" value="수정"
							...
							onclick="boardDelete4()" style="color: #ffffff" />
					</p>
				</div>
			</form>
		</div>
