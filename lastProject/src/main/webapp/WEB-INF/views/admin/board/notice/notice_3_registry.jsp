...
.searchType span:first-child label {
	margin-left: 0
}
...
.searchType.txt_left>span {
	zoom: 1
}

.searchType.txt_left>span:after {
	content: '';
	display: block;
	clear: both
}

.searchType.txt_left>span>label {
	float: left;
	top: 0;
	line-height: 20px;
	margin-right: 5px
...
.searchType.txt_left>span>select {
	float: left
}

.searchType.txt_left>span>select.last {
	width: 130px;
	margin-right: 5px
}
...
<article>
	<div id="page-wrapper">
		<div id="page-inner">
			...
			<hr />
			<form style="display: inline" method="post" action="boardInsert3"
