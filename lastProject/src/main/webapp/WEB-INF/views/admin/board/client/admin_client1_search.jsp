...
<script>
	...
	function go_noticeDetail(noticeCode) {
		...
		noticeForm.action = "/clientUpdateForm?notice_code=" + noticeCode;
		noticeForm.submit();
	}
	//검색함수
			...
			<div class="content">
				<div>
					...
					<form name="noticeDetail">
						<input type="hidden" name="notice_code" value="cn001">
						<div id="viewList">
							<div class="tbl_type1">
							...
							<div class="pagination1 mb20">
								...
								%>		
									...
									%>
										<button type="button" class="btn5" onclick="location.href='client?page=<%=i %>'" title="<%=i%>페이지">
											<span><%=i%></span>
										</button> 
										<% }
									}
