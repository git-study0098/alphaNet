z<%@page import="com.last.common.vo.PagingVO"%>
							...
							<div id="myCarousel" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">
									<div class="item active">
										<img src="<%=request.getContextPath() %>/resources/images/main/banner01.gif" alt="캐러셀1">
									</div>

									<div class="item">
										<img src="<%=request.getContextPath() %>/resources/images/main/banner02.gif" alt="캐러셀2">
									</div>

									<div class="item">
										<img src="<%=request.getContextPath() %>/resources/images/main/banner03.gif" alt="캐러셀3">
									</div>
								</div>
							</div>
						</ul>
