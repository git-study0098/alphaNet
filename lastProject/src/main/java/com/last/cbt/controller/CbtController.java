...
public class CbtController {
	...
	@RequestMapping("/cbt")
	public String cbtMain(Model model, HttpSession session) {
	...
	public String cbtChoice(
			@RequestParam(value = "seVal") String seVal,
			Model model,
			HttpSession session,
	...
	public String cbtDetail(
			@RequestParam(value = "startQuiz") String startQuiz, Model model,
			HttpSession session,
	...
	@ResponseBody
	public Object cbtResult(Model model,
	...
	public String cbt(Model model) throws SQLException {

		List<CbtVo> list = service.selectAllCBTList();
		System.out.println("컨트롤러" + list.get(0).getCbt_name());
		model.addAttribute("list", list);
		return "admin/cbt/ad_cbt";
	}

	// cbt문제 삭제(관리자)
	@RequestMapping("/admin/cbtDelete")
	public String cbtDelete(String id) throws SQLException {
		service.deleteCBT(id);
		return "admin/cbt/ad_cbt";
