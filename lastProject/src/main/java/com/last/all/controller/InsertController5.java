...
@Controller
public class InsertController5 {
	...
	@RequestMapping(value="insert5",headers=("content-type=multipart/*"),method = RequestMethod.POST)
	public String insert(HttpServletRequest request,ClientVO vo,@RequestParam("f")MultipartFile multipartFile,@RequestParam(value="client_code", defaultValue="client05" )String client_code, HttpSession session) throws Exception {
