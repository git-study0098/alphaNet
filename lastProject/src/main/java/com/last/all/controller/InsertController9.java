...
@Controller
public class InsertController9 {
	...
	@RequestMapping(value="insert9",headers=("content-type=multipart/*"),method = RequestMethod.POST)
	public String insert(HttpServletRequest request,ClientVO vo,@RequestParam("f")MultipartFile multipartFile,@RequestParam(value="client_code", defaultValue="client09" )String client_code, HttpSession session) throws Exception {
