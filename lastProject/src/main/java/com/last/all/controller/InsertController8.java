...
@Controller
public class InsertController8 {
	...
	@RequestMapping(value="insert8",headers=("content-type=multipart/*"),method = RequestMethod.POST)
	public String insert(HttpServletRequest request,ClientVO vo,@RequestParam("f")MultipartFile multipartFile,@RequestParam(value="client_code", defaultValue="client08" )String client_code, HttpSession session) throws Exception {
