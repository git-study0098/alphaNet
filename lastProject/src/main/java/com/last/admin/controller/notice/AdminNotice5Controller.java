...
public class AdminNotice5Controller {
	...
	@RequestMapping("/adminRegist5")
	   public String listRegist(){
		      return "admin/board/notice/notice_5_registry";
		   }
	
	@RequestMapping("/notice5")
	public String listNotice(@RequestParam(value="page",defaultValue="1") int pageNumber,Model model,@RequestParam(value="notice_code", defaultValue="notice05" )String notice_code)throws SQLException, ServiceException{
	...
	@RequestMapping(value="/boardInsert5",headers=("content-type=multipart/*"),method=RequestMethod.POST)
	public String boardInsert(HttpServletRequest request,Model model,@RequestParam("f") MultipartFile multipartFile,@RequestParam(value="notice_code" , defaultValue="notice05")String notice){
	...
	@RequestMapping("/boardUpdateForm5")
