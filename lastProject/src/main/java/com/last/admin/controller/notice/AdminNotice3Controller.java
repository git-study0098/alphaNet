...
@Controller
public class AdminNotice3Controller {
	...
	@RequestMapping(value="/boardInsert3",headers=("content-type=multipart/*"),method=RequestMethod.POST)
	public String boardInsert(HttpServletRequest request,Model model,@RequestParam("f") MultipartFile multipartFile,@RequestParam(value="notice_code" , defaultValue="notice03")String notice){
