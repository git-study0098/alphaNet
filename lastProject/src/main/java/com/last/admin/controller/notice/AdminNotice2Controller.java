...
public class AdminNotice2Controller {
	...
	// 검색
	@RequestMapping("/admin/notice/search2")
	public String listNotice1(
		...
		return "admin/board/notice/admin_notice2_search";
	}
	...
	@RequestMapping(value = "/admin/boardUpdate2", headers = ("content-type=multipart/*"), method = RequestMethod.POST)
