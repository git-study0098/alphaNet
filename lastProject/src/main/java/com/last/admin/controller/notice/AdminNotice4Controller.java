...
public class AdminNotice4Controller {
	...
	@RequestMapping("/adminRegist4")
	   public String listRegist(){
		      return "admin/board/notice/notice_4_registry";
		   }
	
	@RequestMapping("/notice")
	public String listNotice(@RequestParam(value="page",defaultValue="1") int pageNumber,Model model,@RequestParam(value="notice_code", defaultValue="notice04" )String notice_code)throws SQLException, ServiceException{
	...
	@RequestMapping(value="/boardInsert4",headers=("content-type=multipart/*"),method=RequestMethod.POST)
	public String boardInsert(HttpServletRequest request,Model model,@RequestParam("f") MultipartFile multipartFile,@RequestParam(value="notice_code" , defaultValue="notice04")String notice){
	...
	@RequestMapping("/boardUpdateForm4")
