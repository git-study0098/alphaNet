...
public class MemPagingVO {
	...
	private List<MemberVo> notice1List;
	 ...
	 * 각 게시판VO 마다 생성되야 함
	 * */
	public MemPagingVO(List<MemberVo> notice1List, int notice1TotalCount,
	...
	public List<MemberVo> getNotice1List() {
		return notice1List;
	}
	...
	public void setNotice1List(List<MemberVo> notice1List) {
		this.notice1List = notice1List;
	}
